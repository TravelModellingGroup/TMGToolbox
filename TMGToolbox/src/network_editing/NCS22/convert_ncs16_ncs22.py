...
#---VERSION HISTORY
'''
    0.0.1 Created on 2022-06-06 by 
...
class ConvertNCS16toNCS22(_m.Tool()):
    ...
    def page(self):
        pb = _tmgTPB.TmgToolPageBuilder(self, title="Convert from NCS16 to NCS22 v%s" %self.version,
                                description="Converts a network from NCS16 to NCS22.",
        ...
        pb.add_select(tool_attribute_name='ncs22_scenario_number',
                      keyvalues=availableScenarioIds,
                      title='NCS22 Scenario:',
                      note="NCS22 Scenario Number")
